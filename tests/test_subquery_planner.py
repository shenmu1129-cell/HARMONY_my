...
def test_structural_multi_goal_question_decomposes_without_temporal_keywords():
    plan = decompose_query(
        "What challenges does Sam face in a healthier lifestyle, and how does he address them?"
    )
    assert plan.decomposed
